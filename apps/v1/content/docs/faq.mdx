...
Try the cluster detection method for better results with borderless or complex tables:
...
Or via CLI:
```bash
opendataloader-pdf document.pdf -f json --table-method cluster
```

For complex tables, Table AI support is coming soon.
