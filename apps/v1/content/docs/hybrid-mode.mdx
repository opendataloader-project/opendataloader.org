...
<Callout type="info">
**Available in v1.6.0+** — OCR for scanned PDFs and Table AI are now available through hybrid mode.
</Callout>
...
| `docling-fast` | Available | OCR, Table AI, layout analysis (local/Docker) |
