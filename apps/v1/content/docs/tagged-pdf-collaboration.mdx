...
description: Partnering with PDF Association and Dual Lab for Tagged PDF standards
---

<div className="flex flex-col md:flex-row justify-center items-center gap-8 mb-8 bg-white p-6 rounded-lg">
<img src="/figures/pdf-association-logo.png" alt="PDF Association" width="160" />
<img src="/figures/hnc-logo.svg" alt="Hancom" width="160" />
<img src="/figures/duallab-logo.png" alt="Dual Lab" width="160" />
</div>
