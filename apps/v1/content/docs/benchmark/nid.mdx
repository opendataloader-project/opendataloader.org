...
![Reading order](https://github.com/opendataloader-project/opendataloader-bench/raw/refs/heads/main/charts/benchmark_reading-order.png)

## Results

| Engine         | Score | Rank |
|----------------|-------|------|
| OpenDataLoader | 0.91  | #1   |
| Docling        | 0.90  | #2   |
| PyMuPDF4LLM    | 0.89  | #3   |
| MarkItDown     | 0.88  | #4   |
