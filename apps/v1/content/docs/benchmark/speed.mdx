...
![Extraction time](https://github.com/opendataloader-project/opendataloader-bench/raw/refs/heads/main/charts/benchmark_extraction-time.png)
...
| Docling        | 0.73           | #4   | 16x slower, highest accuracy   |
